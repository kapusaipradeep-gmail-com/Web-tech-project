...
$html1="<div id='screen' ><span class='print_element' ><b>COURSE ID:".strtoupper($q)."<br>COURSE NAME:".$row9[1]."<br>FAC ID:".$row9[2]."<br>SEMESTER:".$row9[3]."<br></b></span><table cellpadding='1px' id='print_contain' ><tr id='abc2'><th><div><span>ROLL NO.</span></div></th>";
